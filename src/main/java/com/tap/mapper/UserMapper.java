...
public class UserMapper {
    ...
    public static UserDto toDto(User savedUser) {
        ...
        userDto.setStoreId(savedUser.getStore() != null ? savedUser.getStore().getId() : null);   // ← new
        userDto.setBranchId(savedUser.getBranch() != null ? savedUser.getBranch().getId() : null); // ← new
